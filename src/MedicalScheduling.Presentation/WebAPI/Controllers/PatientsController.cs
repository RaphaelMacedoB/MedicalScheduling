...
public sealed class PatientsController : ControllerBase
{
  ...
  public async Task<IActionResult> GetPatients([FromQuery] PatientFilter filter, CancellationToken ct)
  {
    var result = await _mediator.Send(new GetPatientsQuery(filter), ct);
